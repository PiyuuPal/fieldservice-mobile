...
export const style = StyleSheet.create({
  ...
  searchView: { flexDirection: 'row',marginVertical:10, justifyContent: 'space-between', marginHorizontal: 20, borderWidth: 1, borderColor: '#D5DBE4', borderRadius: 8 },
  textboxfield: {
